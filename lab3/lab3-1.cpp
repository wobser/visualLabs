...
int main(int argc, char const *argv[])
{
  ...
  GLFWwindow* window = glfwCreateWindow (w_width, w_height, "SimVis Lab 3", NULL, NULL);
  ...
  ///\todo ADD GEOMETRY HERE to create two triangles that fill the whole window
  float points[] = {
	  -1,-1, 0,
	   1,-1, 0,
	   1, 1, 0,
  ...
  int num_vertices=6; ///\todo SET NUMBER OF VERTICES
  ...
  glBufferData (GL_ARRAY_BUFFER, num_vertices * 3 * sizeof (float), points, GL_STATIC_DRAW);
