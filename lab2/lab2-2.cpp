...
int main(int argc, char const *argv[])
{
  ...
  while (!glfwWindowShouldClose (window)) 
  {
	...
	//genType normalize(genType v);		normalise function calls code
	//genDType normalize(genDType v);	normalise function calls code

    glm::mat4 Model = glm::mat4(1.0f); // identity matrix
	glm::mat4 translate = glm::translate(glm::mat4(1.f), glm::vec3(0.f, -1.f, 0.f));
	...
	//View = normalize(View); //this generates errors in some wierd file
	...
	//glUniformMatrix2x4fv(glGetUniformLocation(shader_program, "wOut"), 1, GL_FALSE, glm::value_ptr(View));
