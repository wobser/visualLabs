// Copy your previous C++ code here, but make sure the file names below are updated.



// Copy lab1-3.cpp here, but make sure the file names below are updated.
// Also copy your GLSL files from 1.3.
...
int main(int argc, char const* argv[])
{
	...
	float positions[] = {
		...
		0.5,-0.5,0.5, //vertex 1	 |Front corners
		0.5,0.5,0.5, //vertex 2		 |
		- 0.5,0.5,0.5, //vertex 3	-|

		- 0.5,-0.5,-0.5, //vertex 4	-|
		0.5,-0.5,-0.5, //vertex 5	 |Back corners
		0.5,0.5,-0.5, //vertex 6		 |
		- 0.5,0.5,-0.5 //vertex 7	-|
	  ///\todo INSERT VERTEX POSITIONS HERE
	};
	int num_vertices = 8; ///\todo SET NUMBER OF VERTICES
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 Projection = glm::perspective(glm::radians(90.0f),
			((float)(w_width) / w_height), near, far);
		...
		Model = glm::rotate(Model, Rotate.y, glm::vec3(-1.0f, 0.0f,
			0.0f));
		Model = glm::rotate(Model, Rotate.x, glm::vec3(0.0f, 1.0f,
			0.0f));		
